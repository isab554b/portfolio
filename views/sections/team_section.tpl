<div id="profil" class="bg-mylightBlue">
  <div class="width_standard padding_y_standard space-y-24 mx-auto">
    <div class="gap-14 md:gap-10 grid grid-cols-1 xl:grid-cols-12 text-white">
        ...
        <div class="flex flex-col gap-y-6 md:gap-y-8">
          <div class="flex">
            <div class="space-y-2">
              ...
              <h2 class="">
                {{ about_us_content["team_section"]["header_text"] }}
              </h2>
            </div>
          </div>
          <div class="space-y-6">
      ...
      <div class="grid col-span-1 xl:col-span-7">
        <div class="flex items-center justify-center">
          <div class="grid gap-14 md:gap-10 md:grid-cols-1">
            <!-- prettier-ignore -->
